...
urlpatterns = [
    ...
    path("Receita/Editar/<int:recipe_id>", views.update_recipe_view, name="receita_editar"),
    path("Receita/Apagar/<int:stock_id>", views.delete_recipe_view, name="receita_apagar"),
]
